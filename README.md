...
```sh
git clone https://github.com/nickjj/docker-rails-example pawhq
cd pawhq
...
The app is named `pawhq` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "pawhq" and update a few Docker related resources.
